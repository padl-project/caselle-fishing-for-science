---
title: "Fishing For Science"
author: "Peter Carlson - Caselle Lab"
date: "2022-06-07"
...
```{r, geographic location table 2, echo = FALSE, message= FALSE, warning= FALSE, include=FALSE}
...
```{r, create data attributes tables, echo = FALSE, message= FALSE, warning= FALSE, include=FALSE}
